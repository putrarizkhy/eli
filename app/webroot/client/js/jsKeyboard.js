var jsKeyboard = {
    settings: {
        buttonClass: "buttonkeyboard", // default button class
    ...
    addKeyDownEvent: function() {
        $("#keyboardCapitalLetter > div.button, #keyboardSmallLetter > div.button, #keyboardNumber > div.button, #keyboardSymbols > div.button").
            bind('mousedown', (function() { $(this).addClass("buttonkeyboardDown"); })).
            bind('mouseup', (function() { $(this).removeClass("buttonkeyboardDown"); })).
            bind('mouseout', (function() { $(this).removeClass("buttonkeyboardDown"); }));
    },
    ...
    defaultKeyboard: {
        ...
        // 1st row
               ...
               { value: "del", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "buttonkeyboard button_del", keyClass: "key key_del" },
        // 2nd row
               { value: 65, buttonClass: "buttonkeyboard button_a" },{ value: 83 },{ value: 68 },{ value: 70 },
               { value: 71 },{ value: 72 },{ value: 74 },{ value: 75 },{ value: 76 },
               { value: "Enter", isChar: "false", buttonClass: "buttonkeyboard button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
               { value: "abc", isChar: "false", buttonClass: "buttonkeyboard button_smallletter", onclick: "jsKeyboard.changeToSmallLetter();", keyClass: "key key_smallletter" },
               { value: 90 },{ value: 88 },{ value: 67 },{ value: 86 },{ value: 66 },{ value: 78 },
               { value: 77 },{ value: 44 },{ value: 46 },{ value: 39 },
        // 4th row
               { value: "123", isChar: "false", buttonClass: "buttonkeyboard button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
               { value: 32, buttonClass: "buttonkeyboard button_space" },
               { value: "#$@", isChar: "false", buttonClass: "buttonkeyboard button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        smallLetter: [
        // 1st row
                ...
                { value: "del", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "buttonkeyboard button_del", keyClass: "key key_del" },
        // 2nd row
                { value: 97, buttonClass: "buttonkeyboard button_a" },{ value: 115 },{ value: 100 },{ value: 102 },
                { value: 103 },{ value: 104 },{ value: 106 },{ value: 107 },{ value: 108 },
                { value: "Enter", isChar: "false", buttonClass: "buttonkeyboard button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
                { value: "ABC", isChar: "false", buttonClass: "buttonkeyboard button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
        ...
        // 1st row       
                ...
                { value: "del", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "buttonkeyboard button_del", keyClass: "key key_del" },
        // 2nd row
                { value: 45, buttonClass: "buttonkeyboard button_dash" },{ value: 47 },{ value: 58 },{ value: 59 },
                { value: 40 },{ value: 41 },{ value: 36 },{ value: 38 },{ value: 64 },
                { value: "Enter", isChar: "false", buttonClass: "buttonkeyboard button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        //3rd row
                { value: "ABC", isChar: "false", buttonClass: "buttonkeyboard button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter()", keyClass: "key key_capitalletterleft" },
                { value: 63 },{ value: 33 },{ value: 34 },{ value: 124 },{ value: 92 },{ value: 42 },{ value: 61 },{ value: 43 },
                { value: "ABC", isChar: "false", buttonClass: "buttonkeyboard button_capitalletterright", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterright" },
        // 4th row
                { value: "#$@", isChar: "false", buttonClass: "buttonkeyboard button_symbolsleft", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" },
                { value: 32, buttonClass: "buttonkeyboard button_space" },
                { value: "#$@", isChar: "false", buttonClass: "buttonkeyboard button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        symbols: [
        // 1st row
            ...
            { value: "del", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "buttonkeyboard button_del", keyClass: "key key_del" },
        // 2nd row
            { value: 95, buttonClass: "buttonkeyboard button_underscore" },{ value: 92 },{ value: 124 },{ value: 126 },
            { value: 60 },{ value: 62 },
        ...
        // 4th row
            { value: "123", isChar: "false", buttonClass: "buttonkeyboard button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
            { value: 32, buttonClass: "buttonkeyboard button_space" },
            { value: "123", isChar: "false", buttonClass: "buttonkeyboard button_numberright", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" }
         ]
    }
}
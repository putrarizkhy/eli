<?php echo $form->create('Book',array('enctype'=>'multipart/form-data'));?>
<fieldset>
...
<?php
echo $form->input('Book.bookfiles', array('label'=>false, 'type'=>'file'));
echo '</p>';?>
</div>
</fieldset>
...
<script type="text/javascript">
          ...
          function showResponse(responseText, statusText, xhr, $form)  { 
                  ...
                  $("#BookAddForm").clearForm();
                  $(".formcontainer").show();
                  $('#ebooktable').append(responseText);

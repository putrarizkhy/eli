...
<h2>Tab Direktori lifeskill</h2>
<p>
Berikut ini adalah halaman dari semua lifeskill yang dibuat, anda dapat memanage halaman ini dengan action yang tersedia
</p>
...
<div class="actions">
	...
	<?php echo $html->link('Masukkan lifeskill Baru','/labs/add/4/',array('class'=>'button')); ?>

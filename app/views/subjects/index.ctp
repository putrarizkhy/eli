      ...
      <div style="">
        ...
        <div class="rack">
          ...
          <div class="datapopuppreview1">
            ...
            <a class="cdpembelajaran" data-folder= "<?php echo $this->webroot;?><?php echo $book['Subject']['folder_name'];?>" href="<?php echo $this->webroot;?><?php echo $book['Subject']['folder_name'];?><?php echo $book['Subject']['file_name'];?>" title="#"><img src="<?php echo $this->webroot?>images/lihat-btn.png"/></a></br>

            <a href="<?php echo $this->webroot;?><?php echo $book['Subject']['folder_name'];?>CD-<?php echo $book['Subject']['id_pustaka'];?>.zip" title="#"><img style="margin-top: 32px;margin-left: 141px;" src="<?php echo $this->webroot?>images/download-btn.png"/></a>
            ...
            <h1><?php echo $book['Subject']['title']?></h1>
            <p><?php echo $book['Subject']['penerbit']?></p>
            <br/>
            <h2>Sinopsis</h2>
            <p><?php echo $book['Subject']['details']?></p>
            <br/>
          ...
          <div class="bookdetailpopup2">
            <dl class="desc-detail">    
              <dt class="altrow">Id</dt>
                <dd class="altrow"><?php echo $book['Subject']['id_pustaka']?>  &nbsp;</dd>
              <dt>Penerbit</dt>
                <dd><?php echo $book['Subject']['penerbit']?> &nbsp;</dd>

                <dt>Kategori</dt>
                <dd><?php echo $book['Category']['name']?> &nbsp;</dd>

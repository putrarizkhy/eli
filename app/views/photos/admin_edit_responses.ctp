    ...
    <a class="gotolinkanchor" data-title="View Photo" data-width="500px" data-height="375" href="<?php echo $this->webroot;?>admin/photos/view/<?php echo $entry['Photo']['id'] ?>"><i class="  icon-new-tab on-right"></i> Lihat</a>
            ...
            <div>
              ...
              <?php if($entry['Photo']['favorite'] == 0):?>
                ...
                <a data-entryid="<?php echo $entry['Photo']['id'];?>" id="do_fav_<?php echo $entry['Photo']['id']?>" href="#" class="nongoldehlo"><i class=" icon-star on-right"></i> Jadikan Fav</a>
              <?php else:?>
                <?php echo $form->input('PhotoFav.action',array('type'=>'hidden','value'=>0));?>
                <a data-entryid="<?php echo $entry['Photo']['id'];?>" id="do_fav_<?php echo $entry['Photo']['id']?>" href="#" class="nongoldehlo"><i class=" icon-star on-right"></i>  Buang dari Fav</a>
              <?php endif;?>
              <?php echo $form->end();?>

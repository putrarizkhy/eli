                  ...
                  <ul class="rb-grid clearfix overlay-grids" id="slide">
                    ...
                    <li class="rb-span-12">
                      ...
                      <div id="a" class="book imageNavinside">&nbsp;</div>
                        <h3 style="margin-top: 180px;"><a class="changepage listbukuactive"  href="">List Buku</a></h3>
                        <h3><a class="changepage favoritebukuactive" href="">Favorite</a></h3>
                        <h3><a href="">Input Buku Baru</a></h3>
                        <h3><a href="">Cetak Daftar Buku</a></h3>
                        <h3><a href="">Cetak Barcode Buku</a></h3>
                            ...
                            <div class="actions">
                              ...
                              <div class="tohide">
                                ...
                                <div class="favoritebukucontent" style="display:none;">
                                  ...
                                  <div class="tags">Ini adalah list buku Favorite</div>
                                  <div class="bottom_line">&nbsp;</div>
                                </div>
                        ...
                        <div class="centercontainer">
                          ...
                          <div class="tohide">
                            ...
                            <div class="favoritebukucontent" style="display:none;">
                              ...
                              <span>Tambah List Favorite</span>
                            </div>
                    ...
                    <li class="contentareatoload areatochangebackground">
                        
                      
                      <div id="spinner_container"><img id="spinner" src="<?php echo $this->webroot;?>images/Preloader_1.gif" alt="" /></div>
                      
                      <div class="view1 view-fifth1 contenareaajax">
                        <div class="mask1">
                          <div class="actions">
                            ...
                            <table class="table hovered" cellpadding="0" cellspacing="0">
                              <thead>
                                <tr class="title_table">
                                  ...
                                  <th><a href="/elips/books/index/page:1/sort:jml_rusak/direction:asc">Rusak</a></th>
                                  <th><a href="/elips/books/index/page:1/sort:onrent/direction:asc">Dipinjam</a></th>
                                  <th><a href="/elips/books/index/page:1/sort:status_buku/direction:asc">Tersedia</a></th>
                                  <th><a href="/elips/books/index/page:1/sort:letak_simpan/direction:asc">Letak</a></th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Rak 1</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/58"><i class=" icon-new-tab on-right"></i>Lihat</a>
                                    <a href="/elips/books/edit/58"><i class="icon-pencil on-right"></i>Edit</a>
                                    <a href="/elips/books/delete/58" onclick="return confirm('Are you sure you want to delete # 58?');"><i class="icon-remove on-right"></i>Hapus</a></td>
                                </tr>

                                <tr class="altrow ">
                                  <td>3</td>
                              
                                  <td>Si Doel Anak Sekolah</td>
                                  ...
                                  <td>Rak 1</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/49"><i class=" icon-new-tab on-right"></i>Lihat</a>
                                    <a href="/elips/books/edit/49"><i class="icon-pencil on-right"></i>Edit</a>
                                    <a href="/elips/books/delete/49" onclick="return confirm('Are you sure you want to delete # 49?');"><i class="icon-remove on-right"></i>Hapus</a></td>
                                </tr>

                                <tr>
                                  <td>4</td>
                                  
                                  <td>Untukmu Idolaku</td>
                                  ...
                                  <td>Rak 1</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/45"><i class=" icon-new-tab on-right"></i>Lihat</a>
                                    <a href="/elips/books/edit/45"><i class="icon-pencil on-right"></i>Edit</a>
                                    <a href="/elips/books/delete/45" onclick="return confirm('Are you sure you want to delete # 45?');"><i class="icon-remove on-right"></i>Hapus</a></td>
                                </tr>
                ...
                <div class="main" id="resume">
                  ...
                  <div class="clearfix sub_page">
                    <div class="clr">
                      ...
                      <div class="header_rightbg">
                        <div class="clr"> 
                          <div class="float_left"><img src="images/phone_img.png" alt="" /></div>
                          <div class="ph_number">+123.456.7890</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="main" id="resume1">
                  ...
                  <ul class="rb-grid clearfix overlay-grids">
                    ...
                    <li class="rb-span-12">
                      ...
                      <h3 style="margin-top: 180px;"><a href="">List Kode DDC</a></h3>
                      <h3><a href="">Tambah Kode DDC</a></h3>
                      <div class="bottom_line4"></div>
                    </li>
                      <!-- // Resume page box1 -->
                      <!-- Resume page box2 -->
                           ...
                           <table class="table hovered" cellpadding="0" cellspacing="0">
                              <thead>
                                <tr class="title_table">
                                    ...
                                    <th><a href="/elips/ddcs/index/page:1/sort:created/direction:asc">Created</a></th>
                                    <th><a href="/elips/ddcs/index/page:1/sort:modified/direction:asc">Modified</a></th>
                                    <th class="actions">Actions</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr class="altrow ">
                                  ...
                                  <td>001</td>
                                  <td>Sejarah</td>
                                  <td>2011-03-21 02:13:28</td>
                                  <td>2011-02-09 19:03:24</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/60"><i class=" icon-new-tab on-right"></i> Lihat</a>
                                    <a href="/elips/books/edit/60"><i class="icon-pencil on-right"></i> Edit</a>
                                    <a href="/elips/books/delete/60" onclick="return confirm('Are you sure you want to delete # 60?');"><i class="icon-remove on-right"></i> Hapus</a>
      ...
      <div class="rb-overlay"> 
            ...
            <div class="main" id="resume2">
              ...
              <ul class="rb-grid clearfix overlay-grids">
                ...
                <li class="rb-span-12">
                  ...
                  <h3 style="margin-top: 180px;"><a class="changepage listbukuactive"  href="<?php echo $this->webroot?>ebooks/bookcategory" data-scope="categoryscope" data-background="#C68000">List Kategori</a></h3>
                ...
                <li class="keteranganatas gotolink" data-url="<?php echo $this->webroot;?>categories/add" data-title="Tambah Kategori">
                 ...
                 <li class="categoryscope contentareatoload areatochangebackground">
                  ...
                  <div class="spinner_container"><img id="spinner" src="<?php echo $this->webroot;?>images/Preloader_1.gif" alt="" /></div>
        ...
        <tr class="altrow " id="category-<?php echo $category['Category']['id'];?>">
          ...
          <td class="actions">
            ...
            <a class="gotolinkanchor" data-title="Edit Kategori" data-width="900px" data-height="500px" href="<?php echo $this->webroot;?>categories/edit/<?php echo $category['Category']['id']?>"><i class=" icon-pencil on-right"></i> Edit</a>
                ...
                <ul class="rb-grid clearfix overlay-grids">
                  ...
                  <li class="rb-span-12">
                    ...
                    <div id="a" class="rack">&nbsp;</div>
                      <h3 style="margin-top: 180px;"><a href="">List Lokasi Buku</a></h3>
                      <h3><a href="">Tambah Lokasi Buku</a></h3>
                    <div class="bottom_line4"></div>
                  </li>
                    <!-- // Services page box1 -->
                    <!-- Services page box2 -->
        ...
        <!-- // Resume Part -->         
                  <ul class="rb-grid clearfix overlay-grids">
                    ...
                    <li class="rb-span-12">
                      ...
                      <h3 style="margin-top: 180px;"><a href="">Laporan Keuangan</a></h3>
                      <h3><a href="">Tambah Laporan</a></h3>
                      <div class="bottom_line4"></div>
                    </li>
                    <!-- // Resume page box1 -->
                    <!-- Resume page box2 -->
                    ...
                    <li class="keteranganatas">
                        <div class="listbukucontent">
                              <br/>
                              <i class="icon-dollar-2 iconlarge6 iconapp"></i><br/><br/>
                              <span>Tambah Kategori</span>
                            </div>
                    </li>
                    <li class="contentareatoload">
                        ...
                        <div class="mask1">
                          <div class="actionss">
                           <table class="table hovered" cellpadding="0" cellspacing="0">
                              <thead>
                                <tr class="title_table">
                                  <th><a href="/elips/categories/index/page:1/sort:id/direction:asc">Id</a></th>
                                  <th><a href="/elips/categories/index/page:1/sort:name/direction:asc">Nama</a></th>
                                  <th><a href="/elips/categories/index/page:1/sort:denda_terlambat/direction:asc">Denda</a></th>
                                  <th><a href="/elips/categories/index/page:1/sort:keterangan/direction:asc">Keterangan</a></th>
                                  <th><a href="/elips/categories/index/page:1/sort:created/direction:asc">Created</a></th>
                                  <th><a href="/elips/categories/index/page:1/sort:modified/direction:asc">Modified</a></th>
                                  <th class="actions">Actions</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr class="altrow ">
                                  ...
                                  <td></td>
                                  <td>2010-11-27 07:40:39</td>
                                  <td>2011-02-22 00:26:05</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/60"><i class=" icon-new-tab on-right"></i> Lihat</a>
                                    <a href="/elips/books/edit/60"><i class="icon-pencil on-right"></i> Edit</a>
                                    <a href="/elips/books/delete/60" onclick="return confirm('Are you sure you want to delete # 60?');"><i class="icon-remove on-right"></i> Hapus</a>
                                ...
                                <tr>
                                  ...
                                  <td>asd</td>
                                  <td>2010-12-03 02:48:54</td>
                                  <td>2011-03-21 02:16:34</td>
                                  <td class="actions">
                                    <a href="/elips/books/view/60"><i class=" icon-new-tab on-right"></i> Lihat</a>
                                    <a href="/elips/books/edit/60"><i class="icon-pencil on-right"></i> Edit</a>
                                    <a href="/elips/books/delete/60" onclick="return confirm('Are you sure you want to delete # 60?');"><i class="icon-remove on-right"></i> Hapus</a>
    ...
    <!-- // Resume Part -->         
              <ul class="rb-grid clearfix overlay-grids">
                ...
                <li class="rb-span-12">
                  ...
                  <h3 style="margin-top: 180px;"><a class="changepage listbukuactive" href="<?php echo $this->webroot?>notifications/showall" data-scope="notificationscope" data-background="#109079">List Pengumuman</a></h3>
            ...
            <div class="main" id="resume6">
              ...
              <ul class="rb-grid clearfix overlay-grids" id="slide">
                ...
                <li class="rb-span-12">
                  ...
                  <div class="bottom_line3"></div>
                  <div class="preloadersmall">
                    <img class="" src="<?php echo $this->webroot;?>images/preloader_small.gif"><br/>
                    <span>Plase wait ...</span>
                  </div>
                  <div id="a" class="pusdig imageNavinside">&nbsp;</div>
                    <h3 style="margin-top: 180px;">

                      <a class="changepage" data-countinside="1" href="<?php echo $this->webroot?>ebooks/listebook" data-scope="bookscope" data-background="#77234E">List Ebook</a>

                    </h3>

                    <h3>
                      <a class="changepage" data-countinside="2" href="<?php echo $this->webroot?>ebooks/showfavorite" data-scope="bookscope" data-background="#77234E">Favorite</a>
                    </h3>
                ...
                <li class="keteranganatas gotolink areatochangebackground" data-url="<?php echo $this->webroot;?>ebooks/add" data-title="Tambah Ebooks" data-width="900px" data-height="375px">
                          ...
                          <tbody id="ebooktable">
                            ...
                            <tr class="altrow ">
                              ...
                              <td class="actions">
                                ...
                                <a class="gotolinkanchor" href="<?php echo $this->webroot;?>ebooks/edit/<?php echo $daftarebook['Ebook']['id'];?>" data-title="Edit Ebook" data-width="900px" data-height="500px"><i class="icon-pencil on-right"></i> Edit</a>
                                <a href="<?php echo $this->webroot;?>ebooks/delete/<?php echo $daftarebook['Ebook']['id'];?>" onclick="return confirm('Are you sure you want to delete <?php echo $daftarebook['Ebook']['title']?>?');"  class="deleteitemtable"><i class="icon-remove on-right"></i> Hapus</a>
                              </td>
                            </tr>
                            <?php endforeach;?>
        ...
        <!-- // Resume Part -->         
                <ul class="rb-grid clearfix overlay-grids">
                  ...
                  <li class="rb-span-12">
                    ...
                    <h3 style="margin-top: 180px;"><a href="">List Kategori</a></h3>
                    <h3><a href="">Tambah Kategori</a></h3>
                    <div class="bottom_line4"></div>
                  </li>
                    <!-- // Resume page box1 -->
                    <!-- Resume page box2 -->

	...
	var $default_options = array(
		...
		'validations' => array(
			'FieldName' => array(
				...
				'check' => true,
				'message' => 'Maaf terjadi kesalahan file tidak bisa di upload silakan ulangi.'
			),
			'Dir' => array(
			...
			'MaxSize' => array(
				...
				'check' => true,
				'message' => 'File melebihi limit, tidak bisa di upload silakan ulangi.'
			),
			'InvalidMime' => array(
				'rule' => array('uploadCheckInvalidMime'),
				'check' => true,
				'message' => 'Tipe File tidak dijinkan, tidak bisa di upload silakan ulangi.'
			),
			'InvalidExt' => array(
